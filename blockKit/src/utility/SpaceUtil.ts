...
export function spacingMapper(paddingMobile: { top: any; end: any; bottom: any; start: any; }, paddingTablet: { top: any; end: any; bottom: any; start: any; }, paddingDesktop: { top: any; end: any; bottom: any; start: any; }) {
  ...
  let style = `@media (max-width: ${
    mobileBreakpoint - 1
  }px) { padding: ${formatPadding(paddingMobile)}; } `;

  style += `@media (min-width: ${mobileBreakpoint}px) { padding: ${formatPadding(
    paddingTablet
  )}; } `;

  style += `@media (min-width: ${tabletBreakpoint}px) { padding: ${formatPadding(
    paddingDesktop
  )}; }`;
